...
export const SearchPage = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const { focusIndex, focusNext, focusPrev, focusTo, unFocus } = useSuggestionsFocus(suggestions);
        ...
        return () => h("div", {
            ...
            h("span", {
                class: "search-close",
                onClick: (event) => emit("toggle-search")
            }, [
                h("svg", {
            ...
            h("div", {
                ...
                showSuggestions.value &&
                    h("ul", {
                    ...
                    }, suggestions.value.map(({ link, title, subtitle }, index) => h("li", {
                        class: [
                            "suggestion",
                            {
                        ...
                        subtitle &&
                            h("span", { class: "suggestion-subtitle" }, subtitle)
                    ]))))
            ])
        ]);
    }
